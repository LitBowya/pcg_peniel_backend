...
router.post('/assign',protect, isAdminOrSuperAdmin, assignUserToMinistry); // Assign user to ministry
router.post('/remove', protect,isAdminOrSuperAdmin, removeUserFromMinistry); // Remove user from ministry
